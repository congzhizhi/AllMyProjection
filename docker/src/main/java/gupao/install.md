...
02 创建mysql容器
	...
	docker run -d --name my-mysql2 -p 3305:3305 -e MYSQL_ROOT_PASSWORD=root --privileged mysql:5.6
	docker run -d -p 3306:3306 -v /soft/mysql/my.cnf:/etc/mysql/mysql.conf.d/mysqld.cnf -v /soft/mysql/data:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=root --name mymysql mysql:5.6
